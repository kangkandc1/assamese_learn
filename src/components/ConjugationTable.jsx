...
export default function ConjugationTable() {
  ...
  useEffect(() => {
    setData(null);
    setError(null);
    const lesson = conjugationtables.find((l) => l.id === id);
    if (!lesson) {
              ...
              <tbody>
                {data.vocab.map((item, i) => (
                  <tr key={i}>
                    ...
                    <td className="cell-assamese">{item.stamm}</td>
                    <td className="cell-assamese">{item.first}</td>
                    <td className="cell-assamese">{item.second}</td>
                    <td className="cell-assamese">{item.third}</td>
                    <td className="cell-assamese">{item.plural}</td>
